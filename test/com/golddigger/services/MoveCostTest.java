...
public class MoveCostTest {
	...
	private static final String STRING_MAP_1 = "wwwwwwwwwww\nwbbcds.frmtw\nwwwwwwwwwww";
	...
	public void setup(){
		...
		costs.put(GoldTile.class.getSimpleName(),50);
	...
	public void testMovementCosts(){
		...
		moveAndTime(Direction.EAST, 200);
		moveAndTime(Direction.EAST, 500);
		moveAndTime(Direction.EAST, 150);
		moveAndTime(Direction.EAST, 100);
		moveAndTime(Direction.EAST, 300);
		moveAndTime(Direction.EAST, 25);
		moveAndTime(Direction.EAST, 500);
		moveAndTime(Direction.EAST, 100);
